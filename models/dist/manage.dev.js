  ...
  branch.find(function (err, docs) {
    if (err) {
      ...
      docs.forEach(function (element) {
        ...
        element.subjects.forEach(function (i) {
      ...
      answer.find({
        ...
        if (err) {
          ...
          var data = {
            ...
            option: req.session.subject,
            questions: req.session.questions,
            usersubmitions: req.session.usersubmitions
          };
    ...
    if (err) {
      ...
      question.find(function (err, questionDocs) {
        if (err) {
          ...
          req.session.questions.forEach(function (element) {
...
function deleteQuestion(req, res) {
  ...
  question.findOneAndRemove({
    question: req.body.question_del,
    subject: req.body.subject
  }, function (err, result) {
    if (err) {
      console.log(err);
...
module.exports = {
  ...
  serveSubject: serveSubject,
  serveFaculty: serveFaculty,
